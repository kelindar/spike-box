namespace Spike.Scripting.REPL
...
module Main = 
  ...
  open Spike.Scripting.Compiler.Core
  open Spike.Scripting.Hosting.FSharp

  let printReplHeader () =
    let header = sprintf @"Spike.Scripting REPL, version: %s" Version.String 
  ...
  let main () =
    ...
    // Create the Spike.Scripting context
