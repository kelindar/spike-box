...
namespace Spike.Box.Threading
{
    ...
    internal sealed class QueuedTaskScheduler : TaskScheduler, IDisposable
    {
        ...
        public QueuedTaskScheduler(int threadCount, string threadName) : this(threadCount, threadName, false, ThreadPriority.Normal, ApartmentState.MTA, 0, null, null) { }
