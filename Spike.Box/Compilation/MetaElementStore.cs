...
namespace Spike.Box
{
    public class MetaElementStore : MetaStore<MetaElement>
    {
        ...
        public override MetaElement CreateInstance(string key, FileInfo file)
        {
            return new MetaElement(key, file, this.App);
        }
        ...
        public override bool TryGet(string key, out MetaElement value)
        {
